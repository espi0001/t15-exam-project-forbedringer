  ...
  return (
    <Card>
      ...
      <CardContent className="mb-6 p-4  rounded">
        ...
        >
          {/* Regular Ticket valg */}
          <Label htmlFor="regular" className={`label-styling border-[2px] shadow-md hover:border-red_color hover:border-[3px] ${bookingData.ticketType === "regular" ? "border-red_color border-[3px] bg-light_grey_color" : "border-grey_color"}`}>
          ...
          {/* VIP Ticket valg */}
          <Label htmlFor="VIP" className={`label-styling border-[2px] shadow-md hover:border-red_color hover:border-[3px] ${bookingData.ticketType === "VIP" ? "border-red_color border-[3px]" : "border-grey_color"}`}>
