...
const Footer = () => {
  ...
  return (
    <footer
      ...
      flex flex-col gap-8 
      font-medium 
      ${isIndexPage ? "text-black bg-white" : "text-white bg-black"}
    `}
    >
        ...
        <form className="flex flex-col lg:flex-row gap-4 items-center lg:items-start w-full lg:w-auto lg:mt-28">
          <input
            ...
            className={`
              ...
              ${isIndexPage ? "border-black text-black focus:ring-gray-500" : "border-white text-white focus:ring-gray-300"}
